...
pub struct ClusterTopologyControlPlaneMachineHealthCheck {
    ...
    pub remediation_template:
        Option<ClusterTopologyControlPlaneMachineHealthCheckRemediationTemplate>,
...
pub struct ClusterTopologyWorkersMachineDeploymentsMachineHealthCheck {
    ...
    pub remediation_template:
        Option<ClusterTopologyWorkersMachineDeploymentsMachineHealthCheckRemediationTemplate>,
    /// UnhealthyConditions contains a list of the conditions that determine
    /// whether a node is considered unhealthy. The conditions are combined in a
    /// logical OR, i.e. if any of the conditions is met, the node is unhealthy.
    #[serde(
